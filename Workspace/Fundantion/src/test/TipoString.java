...
public class TipoString {
	...
	public static void main(String[] args) {
		...
		//Print formatado
		System.out.printf("\n\nValor atribuído a str originalmente: %s \nPalavra traduzida: %s", str, str.replace("Hi", "Oi"));
		
		System.out.println("Frase qualquer".contains("qual"));
		System.out.println("Frase qualquer".indexOf("Qual")); // Retorna -1, indicando que nao encontrou (por causa da letra maisc. )
		System.out.println("Frase qualquer".substring(6));//Substring pode argumentar dois parâmetro inicio e fim, sendo o segundo opcional
